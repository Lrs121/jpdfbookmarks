 ...
 */
package it.flavianopetrocchi.jpdfbookmarks.jpdfviewpanel;

import it.flavianopetrocchi.jpdfbookmarks.pdfview.ViewChangedEvent;
import it.flavianopetrocchi.jpdfbookmarks.pdfview.PageChangedEvent;
import it.flavianopetrocchi.jpdfbookmarks.pdfview.TextCopiedEvent;
import it.flavianopetrocchi.jpdfbookmarks.pdfview.TextCopiedListener;
import it.flavianopetrocchi.jpdfbookmarks.pdfview.ViewChangedListener;
import it.flavianopetrocchi.jpdfbookmarks.pdfview.RenderingStartListener;
import it.flavianopetrocchi.jpdfbookmarks.pdfview.RenderingStartEvent;
import it.flavianopetrocchi.jpdfbookmarks.pdfview.PageChangedListener;
import it.flavianopetrocchi.jpdfbookmarks.pdfview.FitType;
...
//import it.flavianopetrocchi.jpdfbookmarks.start.JPdfBookmarks;
...
@ServiceProvider(service=IPdfView.class)
public class JPedalViewPanel extends JScrollPane implements IPdfView {
    ...
    public JPedalViewPanel() {
        ...
        //ImageIcon icon = Res.getIcon(JPedalViewPanel.class, "/it/flavianopetrocchi/jpdfbookmarks/gfx32/rect-red.png");
        Image image = Utilities.loadImage("/it/flavianopetrocchi/jpdfbookmarks/gfx32/rect-red.png");
        //Image image = icon.getImage();
        rectRedCur = toolkit.createCustomCursor(image, hotSpot, "rect-red");
        image = Utilities.loadImage("/it/flavianopetrocchi/jpdfbookmarks/gfx32/rect-blue.png");
